    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button id="closerole" type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <form id="uniqueForm" method="POST">
                ...
                <div class="modal-footer">
                    <button  id="fermerrole" type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
